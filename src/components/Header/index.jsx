  ...
  return (
    <div className="header">
      ...
      <div className="bottom">
        <div className="inner">
          <div className="text comic-sans-bold">DECOMPILATION PROJECT</div>
          <div className="flex marker-accent-container">
            ...
            <div
              className="marker-accent orange"
            ...
            <div
              className="marker-accent purple"
            ...
            <div
              className="marker-accent magenta"
            ...
            <div
              className="marker-accent yellow"
