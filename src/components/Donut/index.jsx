...
export const Donut = ({ dataHook, selectedHook }) => {
  const [data] = dataHook
  ...
  useEffect(() => {
    ...
    const colors = {
      // [filled, empty]
      main: ['rgb(171,38,114)', 'rgb(61,11,42)'],
      lib: ['rgb(1,126,180)', 'rgb(3,54,74)'],
      overlay1: ['rgb(0,167,0)', 'rgb(0,86,0)'],
      overlay2: ['rgb(255,255,0)', 'rgb(67,67,0)'],
    }
    ...
    for (var i = 0; i < sections.length; i++) {
      ...
      const filled_percentage_bytes =
        (bytes / section_bytes) * segment_percentage
      const empty_percentage_bytes =
        segment_percentage - filled_percentage_bytes
      ...
      // filled
      context.beginPath()
      context.strokeStyle = colors[name][0]
      context.arc(
        xx,
        yy,
        radius,
      ...
      context.beginPath()
      context.strokeStyle = colors[name][1]
      context.arc(
        xx,
        yy,
        radius,
